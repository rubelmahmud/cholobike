<?php
    if(isset($_GET['status'])) {
        ...
        if($_GET['status'] == 'approved') {
            ...
            $message = $ob_sup_admin->cancel_product_by_id($product_id);
        }
    }
...
<div class="row-fluid">
    <div class="box blue span12">
        ...
        <div class="box-content">
            ...
            <a class="quick-button span2" href="manage_cancelled_order.php">
                <i class="icon-eye-open"></i>
                <p>View Cancel Orders</p>
            </a>
                ...
                <tbody>
                    ...
                    if($order_info['order_status'] == 'pending') {
                        ...
                        <td class="center">
                            ...
                            <a class="btn btn-danger" href="?status=cancel&&id=<?php echo $order_info['order_id']; ?>" title="Cancel Order" onclick="return check_cancel(); ">
