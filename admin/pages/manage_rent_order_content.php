<?php
    if(isset($_GET['status'])) {
        ...
        if($_GET['status'] == 'approved') {
            ...
            $message = $ob_sup_admin->cancelled_rent_by_id($rent_order_id);
        }
    }
    ...
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon user"></i>
                ...
                <span class="break"></span>Manage Rent Request (<b> <?php echo $b_info['branch_name']; ?> Branch </b>)
            </h2>
                ...
                <tbody>
                    ...
                    if($order_info['rent_order_status'] == 0) {
                        ...
                        <td class="center">
                            ...
                            <a class="btn btn-danger" href="?status=cancel&&id=<?php echo $order_info['rent_order_id']; ?>" title="Cancel Request" onclick="return check_cancel(); ">
