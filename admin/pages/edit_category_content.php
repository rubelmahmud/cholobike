            ...
            <form name="edit_category_form" class="form-horizontal" action="" method="post">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?php echo $category_info['category_name']; ?>" name="category_name" required class="span6 typeahead" id="typeahead">
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" name="category_description" required="required" id="textarea2" rows="3"><?php echo $category_info['category_description']; ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="selectError3">Category Type</label>
                        <div class="controls">
                            <select id="selectError3" name="category_type" required>
...
<script>
    document.forms['edit_category_form'].elements['category_type'].value='<?php echo $category_info['category_type']; ?>';
