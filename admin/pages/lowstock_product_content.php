...
if($_SESSION['admin_type'] == 0) {
        $query_result = $ob_sup_admin->select_all_product_info_by_type_bike();
} else {
      $query_result = $ob_sup_admin->select_all_product_info_by_type_bike_sa();
}
...
<div class="row-fluid">
    <div class="box blue span12">
        <div class="box-header">
            <h2><i class="halflings-icon hand-right"></i><span class="break"></span>Low Stock Product Filter</h2>
        </div>
        <div class="box-content">

            <a class="quick-button span2" href="lowstock_accessories.php">
...
<div class="row-fluid sortable">		
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon user"></i><span class="break"></span>Low Stock Products</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                    ...
                    <?php
                    if($product_info['minimum_stock_amount'] >= $product_info['stock_amount']) {
                            ?>
                    <tr>
                        ...
                        <td class="center"><?php echo $product_info['minimum_stock_amount']; ?></td>
