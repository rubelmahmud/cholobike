...
if($_SESSION['admin_type'] == 0) {
        $query_result = $ob_sup_admin->select_sales_report_acc();
} else {
      $query_result = $ob_sup_admin->select_sales_report_acc_sa();
}
...
<div class="row-fluid">
    <div class="box blue span12">
        <div class="box-header">
            <h2><i class="halflings-icon hand-right"></i><span class="break"></span>Best Selling Accessories Filter</h2>
        </div>
        <div class="box-content">

            <a class="quick-button span2" href="sales_report_product.php">
...
<div class="row-fluid sortable">		
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon user"></i><span class="break"></span>Best Selling Accessories</h2>
            <div class="box-icon">
