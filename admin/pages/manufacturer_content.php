            ...
            <form class="form-horizontal" action="" method="post">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="manufacturer_name" required class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group hidden-phone">
                        <label class="control-label" for="textarea2">Manufacturer Description</label>
                        <div class="controls">
                            <textarea class="cleditor" name="manufacturer_description" required="required" id="textarea2" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="selectError3">Manufacturer Type </label>
                        <div class="controls">
                            <select id="selectError3" name="manufacturer_type" required="required">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="selectError3" name="publication_status" required="required">
