...
$category_query_result=$obj_app->select_all_published_category_by_type_accessories();
$manufacturer_query_result=$obj_app->select_all_published_mannufacturer_by_type_accessories();
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Accessories</h2>
            <div class="box-icon">
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_sku" required  class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="selectError3" name="category_id" required onchange="handleSelect(this)">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="selectError3" name="manufacturer_id" required onchange="mSelect(this)">
